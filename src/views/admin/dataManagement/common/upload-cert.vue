<template>
    <div class="uploadSeal">
        <el-button size="small" @click="show">管理证书资料</el-button>
        ...
        <el-dialog
            ...
            <div style="margin-bottom: 10px;">已上传证书资料：</div>
            <ul class="showLists">
...
export default {
    ...
    methods:{
        show(){
            this.$api.get('/Admin/Competition/selectCertificateFile',{
        ...
        submit(){
            this.$api.post('/Admin/Competition/saveCertificateFile',{
                cid: this.competitionId,
